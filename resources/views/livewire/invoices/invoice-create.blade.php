<div class="d-inline">
    <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalFormInvoice">
    ...
    <div wire:ignore.self class="modal fade" id="modalFormInvoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        @if(!array_key_exists(request('type'),\App\Models\Invoice::typeList(false)))
                            <div class="form-group col-6">
                                ...
                                <select wire:model="invoice.type" name="type" class="form-control">
