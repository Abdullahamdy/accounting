<div class="d-inline">
    <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalFormIndexAccount">
        انشاء فهرس حساب
    </button>

    <div wire:ignore.self class="modal fade" id="modalFormIndexAccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
